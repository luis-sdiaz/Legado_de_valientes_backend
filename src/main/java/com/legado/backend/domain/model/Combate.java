...
@Document(collection = "combates")
public class Combate implements Identificable {
    ...
    public Combate(String jugador1Id, String mascota1Id, String jugador2Id, String mascota2Id) {
